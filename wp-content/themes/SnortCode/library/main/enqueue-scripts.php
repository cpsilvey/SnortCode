...
function blankie_scripts()
  {
      ...
      // Enqueue Recover Password Scripts
      wp_enqueue_script( 'recover',      get_template_directory_uri() . '/js/recover-password.js', array( 'jquery' ), '1.0', true );
  }
