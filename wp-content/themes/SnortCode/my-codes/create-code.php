...
<h1>Create New Code</h1>
    <div class="card" class="clearfix">
        <div id="create-code">
            <label>QR Code Name<span>A descriptive name makes your codes easier to organize and search.<span></label>
            ...
            <ul id="create-code-messages"></div>

            <a href="#" id="create-code-submit" class="button-aqua">Generate Code</a>
